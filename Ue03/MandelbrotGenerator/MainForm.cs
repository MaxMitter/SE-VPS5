...
namespace MandelbrotGenerator {
    public partial class MainForm : Form {
        ...
        public MainForm() {
            ...
            //generator = new AsyncThreadImageGenerator();
        ...
        private void generator_OnImageGenerated(object sender, EventArgs<Tuple<Area, Bitmap, TimeSpan>> e) {
            if (InvokeRequired) {
                Invoke(new EventHandler<EventArgs<Tuple<Area, Bitmap, TimeSpan>>>(generator_OnImageGenerated), sender, e);
            } else {
