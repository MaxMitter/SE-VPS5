...
namespace Quandl.UI
{
    public partial class QuandlViewer : Form
    {
        ...
        {
            return Task.Run(() => GetSeries(stockValues, name)); // empfehlung
        }
        ...
        private void DisplayData(List<Series> seriesList)
        {
            if (InvokeRequired)
            {
                this.Invoke(new Action<List<Series>>(DisplayData), seriesList);
            }
            else
            {
                chart.Series.Clear();
        ...
        private void SaveImage(string fileName)
        {
            if (InvokeRequired)
            {
                this.Invoke(new Action<string>(SaveImage), fileName);
            }
            else
            {
